...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<Object> add(@RequestHeader("X-Sharer-User-Id") @NotNull Long userId,
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<Object> get(@PathVariable @NotNull @Positive Long itemId,
    ...
    @GetMapping
    public ResponseEntity<Object> getAll(@RequestHeader("X-Sharer-User-Id") @NotNull Long userId) {
