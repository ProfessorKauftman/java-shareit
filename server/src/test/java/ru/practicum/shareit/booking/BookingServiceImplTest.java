...
class BookingServiceImplTest {
    ...
    void createWhenEndIsBeforeStartShouldThrowValidationException() {
        ...
        assertEquals(bookingValidationException.getMessage(),
    ...
    void createWhenItemIsNotAvailableShouldThrowValidationException() {
        ...
        assertEquals(bookingValidationException.getMessage(), "The item is not available for booking.");
    }
    ...
    void createWhenItemOwnerEqualsBookerShouldThrowValidationException() {
        ...
        assertEquals(bookingNotFoundException.getMessage(), "The item was not found.");
    }
    ...
    void updateShouldStatusNotWaiting() {
        ...
        assertEquals(bookingValidationException.getMessage(), "Reservation not with the WAITING status");
    }
    ...
    void updateWhenUserIsNotItemOwnerShouldThrowNotFoundException() {
        ...
        assertEquals(bookingNotFoundException.getMessage(), "The user is not the owner");
    }
    ...
    void getByIdWhenBookingIdIsNotValidShouldThrowObjectNotFoundException() {
        ...
        assertEquals(bookingNotFoundException.getMessage(), "The reservation was not found.");
    }
    ...
    void getByIdWhenUserIsNotItemOwnerShouldThrowObjectNotFoundException() {
        ...
        assertEquals(bookingNotFoundException.getMessage(),
                "The user is not the owner or the author of the reservation");
    }
